...
**Fleet designation:** `sc-scratchjr` · Part of the Counted fleet.

## Abstract

Tablet kernel for ages 5-7: icon blocks, character pads, timed sequences. This repository ships a self-contained, deterministic implementation:
